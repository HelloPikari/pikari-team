...
class Card_Renderer {
    ...
    /**
     * Renders the QR code carousel slide.
     *
     * Same logic as render_qr — checks QR_Code class availability and post_id,
     * generates SVG, and wraps in a container div. Skipped if QR_Code is unavailable
     * or post_id is missing.
     *
     * @param array<string, mixed> $data    Member data from Template_Tags::get_member_data().
     * @param string               $context Rendering context.
     * @return void
